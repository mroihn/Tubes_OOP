...
int main(){
    pair<int,int> n(5,5);
    // Petani p("Budi",n,n);
    // Tanaman* t1 = new Material_Plant(1,"APL","hahuy",5,4);
    // Tanaman* t2 = new Fruit_Plant(2,"ORG","hihihiha",7,8);
    ...
    u.setPenyimpanan(0, 0, new Fruit(1, "FRT", "Apple", "Local", 1, 5));
    u.setPenyimpanan(0, 1, new Material(2, "MAT", "Wood", "Oak", 1, 3));
    u.setPenyimpanan(1, 1, new Meat(3, "MET", "Beef", "Local", 2, 10));
